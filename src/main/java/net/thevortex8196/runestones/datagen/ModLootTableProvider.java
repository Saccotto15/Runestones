...
public class ModLootTableProvider extends FabricBlockLootTableProvider {
    ...
    public LootTable.Builder dropsAmount(Block block, Item drop, Float amount_min, Float amount_max) {
        ...
        return this.dropsWithSilkTouch(block, (LootPoolEntry.Builder)this.applyExplosionDecay(block, ItemEntry.builder(drop).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(amount_min, amount_max)))));
    }
}
